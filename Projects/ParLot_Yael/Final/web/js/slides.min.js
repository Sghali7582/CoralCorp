window.pluginsAttached ? alert("Attention: plugins.js library is attached twice and needs to be removed. The slides.min.js already contains both of scripts.") : window.pluginsAttached = 1, function (a) {
    ...
    c.eventName = "resizeEnd", c.delay = 250, c.poll = function () {
        var b = a(this), d = b.data(c.eventName);
    ...
    function c(b, c) {
        ...
        function oa() {
            for (var a = [], b = 0; b <= 5; b++) a.push({start: {x: 0, y: 0}, end: {x: 0, y: 0}, identifier: 0});
            return a
        }
        ...
        var Da = y || A || !c.fallbackToMouseEvents,
            ...
            Ga = Da ? A ? z ? "MSPointerUp" : "pointerup" : "touchend" : "mouseup", Ha = Da ? null : "mouseleave",
            Ia = A ? z ? "MSPointerCancel" : "pointercancel" : "touchcancel", Ja = 0, Ka = null, La = 0, Ma = 0, Na = 0,
            Oa = 1, Pa = 0, Qa = 0, Ra = null, Sa = a(b), Ta = "start", Ua = 0, Va = null, Wa = 0, Xa = 0, Ya = 0,
            Za = 0, $a = 0, _a = null, ab = null;
        try {
    ...
    var d = "left", e = "right", f = "up", g = "down", h = "in", i = "out", j = "none", k = "auto", l = "swipe",
        m = "pinch", n = "tap", o = "doubletap", p = "longtap", q = "horizontal", r = "vertical", s = "all", t = 10,
        u = "start", v = "move", w = "end", x = "cancel", y = "ontouchstart" in window,
        z = window.navigator.msPointerEnabled && !window.navigator.pointerEnabled,
        A = window.navigator.pointerEnabled || window.navigator.msPointerEnabled, B = "TouchSwipe", C = {
            fingers: 1,
            threshold: 75,
    ...
    a.fn.swipe = function (c) {
        ...
        PHASE_END: w,
        PHASE_CANCEL: x
    }, a.fn.swipe.directions = {LEFT: d, RIGHT: e, UP: f, DOWN: g, IN: h, OUT: i}, a.fn.swipe.pageScroll = {
        NONE: j,
        HORIZONTAL: q,
        VERTICAL: r,
        AUTO: k
    ...
    f.prototype.init = function () {
        ...
        var c = this, d = 0, e = i[b].replace("{url}", encodeURIComponent(this.options.url));
    ...
    b.prototype.listen = function () {
        ...
        var a = this._fullWidth, b = this._fullHeight, d = (window.scrollY, a / this._targetImage.width),
            e = window.innerHeight - c.OFFSET, f = window.innerWidth - c.OFFSET, g = a / b, h = f / e;
        ...
        this._targetImage.offsetWidth;
        var b = a(this._targetImage), c = window.scrollY, d = c + window.innerHeight / 2, e = window.innerWidth / 2,
            f = b.top + this._targetImage.height / 2, g = b.left + this._targetImage.width / 2;
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    ...
    var a = document.documentElement, b = window, c = function (c, d) {
        ...
        propName: "scrollTo", API: 2, version: "1.7.5", init: function (a, d, e) {
    ...
    if (!c.TweenLite) {
        ...
        var I = [], J = {}, K = F._internals = {isArray: n, isSelector: G, lazyTweens: I}, L = F._plugins = {},
            M = K.tweenLookup = {}, N = 0, O = K.reservedProps = {
                ease: 1,
                delay: 1,
                overwrite: 1,
                onComplete: 1,
    ...
    return d._resetLayout = function () {
        ...
        var c = this.horizontalColIndex % this.cols, d = a > 1 && c + a > this.cols;
        c = d ? 0 : c;
    ...
    var a = function () {
        ...
        var b = 90 == Math.abs(window.orientation) ? screen.height : screen.width, c = b / window.innerWidth;
...
$(window).on("load", function () {
    ...
    function a() {
        ...
        if (a && $('.slide[data-name="' + a + '"]').length > 0) {
            ...
            window.isMobile && window.isSimplifiedMobile || window.isScroll ? b.length && (!window.preload || window.loaded ? $("html,body").stop().clearQueue().animate({scrollTop: b.position().top}, window.effectSpeed) : $(window).on("load", function () {
                $("html,body").stop().clearQueue().animate({scrollTop: b.position().top}, window.effectSpeed)
    ...
    function d(a) {
        if (a = parseInt(a), !(window.isMobile && window.isSimplifiedMobile || window.isScroll)) {
            h();
            var b = $(".slide").eq(a - 1), c = $(".slide.selected"), d = c.index(".slide") + 1;
    ...
    function f() {
        p++, p >= 2 && (m(), p = 0), $(".slide").each(function (a, b) {
            var c = $(b), d = c.index(".slide"), e = $(document).scrollTop(), f = c.offset().top, g = c.height(),
                i = window.windowHeight / 2 > g ? g / 2 : window.windowHeight / 2,
                j = f < window.windowHeight + e - i && f > e - g + i,
                k = 2 * ((e + window.windowHeight - f) / (window.windowHeight + g) - .5), l = !0;
            0 === e && (l = 0 === a), e + window.windowHeight === window.documentHeight && (l = a === window.stages - 1), 0 != window.setStageClasses && (j && l ? (c.prevAll(".slide").addClass("before").removeClass("after"), c.nextAll(".slide").addClass("after").removeClass("before"), c.addClass("selected animate active").removeClass("after before"), window.stage === d + 1 && window.firstTimeTrigger || (window.stage = d + 1, $(window).trigger("slideChange", [window.stage, c]), 1 === window.stage ? n.addClass("firstSlide") : n.removeClass("firstSlide"), window.stages === window.stage ? n.addClass("lastSlide") : n.removeClass("lastSlide"), n.removeClassByPrefix("stage-").addClass("stage-" + window.stage), c.hasClass("whiteSlide") ? n.addClass("whiteSlide") : n.removeClass("whiteSlide"), "auto" == window.isAnimated && (window.clearElementAnimation = setTimeout(function () {
                ...
                var a = $(this), b = parseInt(a.data("parallax-velocity")) ? parseInt(a.data("parallax-velocity")) : 50,
                    c = k * b;
    ...
    function g(a) {
        var b = $(window).scrollTop(), c = $(a), d = c.height(), e = b + window.windowHeight, f = c.offset().top,
            g = f + d;
    ...
    function h() {
        setTimeout(function () {
            $(v).length > 0 && $(v).each(function (a, b) {
                ...
                var c = $(".slide.selected"), d = parseInt(c.data("parent-slide-id")),
    ...
    function j(a) {
        if (a = "undefined" != typeof a && a, $.isArray(window.popupShown)) {
            var b = a ? a : window.popupShown.slice(-1)[0], c = $('.popup.visible[data-popup-id="' + b + '"]'),
                d = c.find("iframe"), e = c.find("video");
            d.length > 0 && $(d).each(function (a, b) {
                var c = $(b).attr("src"), d = c.indexOf("?autoplay") > -1 ? "?" : "&";
    ...
    function k() {
        ...
        a.length && $(a).each(function (a, b) {
            var c = window.windowWidth, d = $(b).hasClass("later") ? 767 : 1024,
                d = $(b).data("equal-collapse-width") ? parseInt($(b).data("equal-collapse-width")) : d,
                e = $(b).find(".equalElement"), f = $(this).hasClass("equalMobile");
            if (c >= d || f) {
                var g = 0;
                $(e).each(function (a, b) {
    ...
    function l(a, b) {
        ...
        var c = a.offset(), d = a.position(), e = window.popupShown ? Math.ceil(d.top) : Math.ceil(c.top),
            f = Math.ceil(c.left), g = a.data("dropdown-id"), h = $('.dropdown[data-dropdown-id="' + g + '"]'),
            i = a.data("dropdown-position") ? a.data("dropdown-position") : h.attr("class"), i = i.split(" ");
    ...
    d(window.stage), $(".grid.masonry").masonry({
        ...
        if ("increase" === a ? a = window.stage + 1 >= window.stages ? window.stages : window.stage + 1 : "decrease" === a && (a = window.stage - 1 < 1 ? 1 : window.stage - 1), window.isMobile && window.isSimplifiedMobile || window.isScroll) {
            window.stage = a;
            var b = $(".slide:eq(" + (window.stage - 1) + ")"), c = $(b).offset().top;
    ...
    $("html,body").on("DOMMouseScroll mousewheel scroll touchmove", function (a) {
        var b = $(".slide.selected .content"), c = Math.ceil(Math.abs(a.deltaY) * a.deltaFactor),
            d = window.isFirefox ? 2 : 1, e = window.isWindows ? 2 * d : d,
            f = a.originalEvent.wheelDelta ? a.originalEvent.wheelDelta : a.deltaY * a.deltaFactor, g = f * d * e,
            h = a.deltaY >= 0 ? "up" : "down", i = b.scrollTop(), j = b.find(".container").outerHeight(),
            k = detectZoom.device(), l = window.isFirefox && window.isWindows ? 200 : window.minScrollToSlide;
        if (c) {
            if (window.isScroll && !window.sidebarShown && !window.popupShown && !window.blockScroll) if (window.smoothScroll && !window.isMobile) {
                ...
                var m = $(window), o = m.scrollTop(), p = o - g;
            ...
            window.isScroll || window.isMobile && window.isSimplifiedMobile || (j > window.windowHeight && ("up" === h && 0 === b.scrollTop() || "down" === h && b.scrollTop() + window.windowHeight >= Math.floor(j / k) ? window.allowSlide = 1 : window.allowSlide = 0, window.panelsToHide && ("down" === h && b.scrollTop() > 0 ? n.addClass("hidePanel-top") : "up" === h && n.removeClass("hidePanel-top"), n.addClass("hidePanel-bottom"), "down" === h && b.scrollTop() + window.windowHeight >= Math.floor(j / k) ? n.removeClass("hidePanel-bottom") : "up" === h && n.addClass("hidePanel-bottom")), window.sidebarShown || window.popupShown || window.blockScroll || (window.smoothScroll ? (a.preventDefault(), g > 1500 && (g = 1500), g < -1e3 && (g = -1500), TweenLite.to(b, .5, {
                scrollTo: {
                    y: i - g,
                    autoKill: !1
                }, ease: Power4.easeOut, overwrite: 5
    ...
    if ($(".mobile .slides:not(.scroll):not(.simplifiedMobile), .slides.desktopSwipe").swipe({
        swipeStatus: function (a, b, c, d) {
            ...
            var e = $(".slide.selected .content"), f = Math.floor(e.find(".container").outerHeight()), g = "up",
                h = "down", i = window.minSwipeToSlide, j = window.innerHeight;
        ...
        var c = $(b).parents(".panel"), d = $(c).find(".desktop"), e = b, f = $(c).hasClass("forceMobileView");
        ...
        var q, r = 0, s = window.hideOnScrollSensitivity ? window.hideOnScrollSensitivity : 100,
            t = $(".panel.hideOnScroll");
        $(window).on("mousewheel", function (a) {
            var b = $(this).scrollTop(), c = $(t), d = Math.ceil(Math.abs(a.deltaY) * a.deltaFactor);
    ...
    $(document).on("keydown", function (a) {
        var b = 2.5, c = 50, d = $(".slide.selected .content"), f = d.scrollTop(), g = f + parseInt(b * c);
    ...
    var u = $(".navigation"), v = $(u).find("ul"), w = $(".slide:not(.exclude)").length;
    $(v).length > 0 && ($(v).is(":empty") && $(v).each(function (a, b) {
        ...
        var a = $(this).index(), b = $(".slide:not(.exclude):eq(" + a + ")").index(".slide");
        $(this).blur(), window.changeSlide(b + 1)
    }), $(".side").hasClass("compact") || $(window).on("load resize ready", function () {
        var a = window.windowHeight - 140, b = $(".side").removeClass("compact").find("ul"), c = 0;
        ...
        var b = $(this).attr("href"), c = b.split("#")[1],
        ...
        var b = a, c = $('.sidebar[data-sidebar-id="' + b + '"]'), d = $(c).hasClass("animated");
        ...
        var b = a, c = $('.popup[data-popup-id="' + b + '"]'), d = c.hasClass("animated");
        if (c.length > 0 && (i(), $(c).addClass("visible"), $(window).trigger("popupShown"), d && setTimeout(function () {
            ...
            var e = $(c), f = e.find("iframe"), g = e.find("video");
            if (f.length > 0) {
                var h = $(f).attr("src"), j = h.indexOf("?") > -1 ? "&" : "?";
    ...
    $(x).length > 0 && $(x).each(function (a, b) {
        var c = $(b), d = c.data("slider-id"), e = c.find(".selected").index();
        if (window.sliderStatus && $html.removeClassByPrefix("slider_" + d).addClass("slider_" + d + "_" + e), c.hasClass("autoplay")) {
            var f = c.data("slider-interval") ? parseInt(c.data("slider-interval")) : 5e3, g = setInterval(function () {
                c.trigger("next")
            }, f);
        ...
        (c.hasClass("clickable") || c.hasClass("autoplay")) && c.on("click next", function (a) {
            var b = $(this), c = b.children(".selected"), d = c.nextOrFirst("li"), e = d.index(),
                f = b.data("slider-id"), g = $('.controller[data-slider-id="' + f + '"]'), h = b.hasClass("animated"),
                i = a.target;
    ...
    if (y.length > 0) {
        ...
        y.on("click", z, function () {
            var a = $(this), b = a.closest(".controller"), c = b.find(".selected"), d = $(b.find(z)).index(a),
                e = b.data("slider-id"), f = $('.slider[data-slider-id="' + e + '"]'), g = f.hasClass("animated");
    ...
    $("[data-slider-action]").click(function () {
        if ($(this).data("slider-id")) {
            var a, b, c = $(this), d = c.data("slider-id"), e = c.data("slider-action"),
                f = $('.slider[data-slider-id="' + d + '"]'), g = $('.controller[data-slider-id="' + d + '"]'),
                h = g.data("controller-selector") ? g.data("controller-selector") : "li", i = f.find(".selected"),
        ...
        var b = a, c = $('.dialog[data-dialog-id="' + b + '"]');
        ...
        var a = $(this).parents(".dialog"), b = $(this).data("dialog-action"), c = a.data("dialog-id"),
            d = a.data("set-cookie"), e = a.data("cookie-name") ? a.data("cookie-name") : c,
            f = !a.data("cookie-value") || a.data("cookie-value"), g = a.data("cookie-path");
        a.addClass("hide").slideUp(500, function () {
            $(this).removeClass("hide"), d && "close" == b && $.cookie(e, f, {expires: d, path: g})
        })
    }), $(".dialog[data-set-cookie]").each(function (a, b) {
        var c = $(b).data("dialog-id"), d = $(b).data("cookie-name") ? $(b).data("cookie-name") : c;
        ...
        var a = parseFloat($(this).attr("data-dialog-delay")), b = $(this);
        ...
        var a = parseFloat($(this).attr("data-dialog-hide-delay")), b = $(this);
        isNaN(a) || setTimeout(function () {
        ...
        $(b).ajaxForm(function () {
            var a = $(b), c = $(b).find('[type="submit"]'), d = !!c.is("input"),
                e = c.data("success-text") ? c.data("success-text") : "Done!",
                f = c.data("success-class") ? c.data("success-class") : "green", g = d ? c.val() : c.html(),
                h = c.attr("class");
        ...
        var c = $(b), d = c.data("sound-id"), e = c[0], f = $('.soundTrigger[data-sound-id="' + d + '"]');
        e.autoplay ? f.addClass("playing") : f.removeClass("playing")
    }), $(".soundTrigger").click(function () {
        var a = $(this).data("sound-id"), b = $('audio[data-sound-id="' + a + '"]'),
        ...
        !b[0].paused || "toggle" !== c && "play" !== c ? "toggle" !== c && "pause" !== c || (b.animate({volume: 0}, d, function () {
            b[0].pause()
        }), $(this).removeClass("playing")) : (b[0].play(), b.animate({volume: 1}, d), $(this).addClass("playing"))
    })
